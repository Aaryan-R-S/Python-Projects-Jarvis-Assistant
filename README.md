...
<p align="center">
  ...
  <h3 align="center">Jarvis Assistant</h3>
...
This is python app which mimics the Jarvis AI assistant. It uses various python modules as mentioned in the Installation section
...
- Clone the repo
   ```sh
   git clone https://github.com/Aaryan-R-S/Python-Projects-Jarvis-Assistant.git
   ```
- Python Modules
  - `pip install pyttsx3`
